...
The consensus data can then be integrated into your pose analysis pipeline at `/Users/dev/Developer/pose/` to automatically crop images using crowd-sourced data instead of manual or unreliable automatic cropping.
